...
while True:
    ...
    blob = cv2.dnn.blobFromImage(color_image, size=scaled_size, swapRB=True, crop=False)
    net.setInput(blob)
    ...
    for detection in detections[0, 0]:
        ...
        if score > 0.8 and idx == 0:
            ...
            lineType = 2
            cv2.putText(color_image, height_txt, bottomLeftCornerOfText, font, fontScale, fontColor, lineType)
